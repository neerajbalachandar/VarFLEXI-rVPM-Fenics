...
# refer line 900 for the heave force definition and usage
...
t_heave = Function(Vt, name="TipHeaveForce")
...
def Wext(u_test):
    return dot(u_test, t_aero + t_heave) * ds_aero(5)
...
for i_step in range(Nsteps):
    ...
    for newton_it in range(newton_maxit):
        ...
        u.vector().axpy(1.0, du_newton.vector())
