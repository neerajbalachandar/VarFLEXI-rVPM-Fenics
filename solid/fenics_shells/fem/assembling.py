...
def projected_assemble(U_P, a, L, bcs=None, A=None, b=None,
    ...
    a_dummy_form_dolfin = _create_dolfin_form(
        a_dummy_form, form_compiler_parameters)
    L_dummy_form_dolfin = _create_dolfin_form(
        L_dummy_form, form_compiler_parameters)

    mpi_comm = a_dummy_form_dolfin.mesh().mpi_comm()
    A = _create_tensor(mpi_comm, a_dummy_form_dolfin,
                       a_dummy_form_dolfin.rank(), backend, A)
    b = _create_tensor(mpi_comm, L_dummy_form_dolfin,
                       L_dummy_form_dolfin.rank(), backend, b)
